...
map.getView().fit([7918211.539944, 2638944.346701, 8201116.504478, 2852571.838542], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Sant Sarovar Barrage</h2>';
        return titleElement;
    })(),
